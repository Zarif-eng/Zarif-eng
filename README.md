...
| **[Audi L5 Inline-5](https://github.com/Zarif-eng/audi-l5-engine)** | DOHC inline-5 engine modelled to a 65 mm bore/stroke constraint, then driven as a mechanism: one crankshaft input synchronising 5 pistons and 20+ valves, plus an assembly/disassembly sequence for maintenance analysis. Modelled 8 of 34 parts and managed the team. | `CATIA V5` `DMU Kinematics` |
| **[AutoCAD Drawings](https://github.com/Zarif-eng/autocad-drawings)** | Four drawing assignments working up from tangent-arc profile geometry to a fully dimensioned production drawing with section views and a bolt-circle scheme. Vector PDFs. | `AutoCAD` |
...
| **[B58 Engine](https://github.com/Zarif-eng/b58-engine)** | Solo build of BMW's B58 turbocharged inline-6 — the balanced counterpart to the inline-5, done alone rather than in a team. Engine block modelled; in progress. | `CATIA V5` |
